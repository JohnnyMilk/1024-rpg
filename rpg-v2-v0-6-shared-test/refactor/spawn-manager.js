...
class V07SpawnManager{
 ...
 hero({tier=2,special=false,profession=null,reincarnated=false,reincarnateEligible=null,...extra}={}){const p=this.pickEmpty();if(!p)return null;const eligible=reincarnateEligible===null?!!special&&!reincarnated:!!reincarnateEligible;return this.board.add({type:'hero',tier,r:p[0],c:p[1],hits:0,special:!!special,profession:special?profession:null,guard:false,revived:false,reincarnated:!!reincarnated,reincarnateEligible:eligible,...extra})}
