...
window.V07StandaloneLoader={
 ...
 async start(options={}){if(!window.V07GameRuntime)await this.load(options);const runtime=new V07GameRuntime(options);if(options.skillDefinitions)runtime.registerSkills(options.skillDefinitions);await runtime.boot();window.__V07_RUNTIME__=runtime;return runtime}
};
})();