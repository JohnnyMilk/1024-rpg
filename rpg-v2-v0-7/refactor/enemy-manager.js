...
class V07EnemyManager{
 ...
 async run(){const phaseEnemies=[...this.r.state.living('enemy')];for(const enemy of phaseEnemies){if(!this.r.units.alive(enemy))continue;await this.takeTurn(enemy)}return true}
