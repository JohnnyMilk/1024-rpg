...
class V07ProfessionManager{
 constructor({runtime,trace=()=>{},random=Math.random}){this.r=runtime;this.trace=trace;this.random=random;this.profession=runtime.config.profession||null;this.bind()}
