...
class GiantElephantGuard{
 ...
 async afterPlayerPhase(){if(this.state!=='WARNING')return false;this.state='COLLAPSING';this.emit();await this.a.collapseBottomRow?.();this.collapseRows--;if(this.collapseRows>0){this.state='WARNING';this.a.setWarningRow?.((this.a.getRows?.()||4)-1);this.a.render?.()}else{this.state='DONE';this.a.setWarningRow?.(-1);this.a.render?.()}this.emit();return true}
}
