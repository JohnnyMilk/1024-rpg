...
const details={stomp:['🗿 踐踏　無 CD','沒有其他可發動技能時的普通行動。朝最近英雄逼近；接觸攻擊造成 2 點傷害。'],charge:['🐘 衝陣　CD 3','同一直行或直列且路徑可衝撞時，最多衝 2 格；撞擊造成 1 點傷害並強制推動。被推出棋盤的單位直接淡出並移除。'],quake:['💥 震地　CD 4','周圍 8 格存在英雄時發動；範圍內所有英雄受到 2 點傷害。']};
