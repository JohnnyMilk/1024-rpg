...
const details={stomp:['🗿 踐踏　無 CD','沒有其他可發動技能時的普通行動。朝最近英雄逼近；接觸攻擊造成 2 點傷害。'],charge:['🐘 衝陣　CD 3','同一直行或直列且路徑可衝撞時，持續衝撞並推動整串單位，直到最末端的單位被推出棋盤為止；整串受撞擊位移的單位各受到 1 點傷害並被強制推動。被推出棋盤的單位直接淡出並移除。'],quake:['💥 震地　CD 4','周圍 8 格存在英雄時發動；範圍內所有英雄受到 2 點傷害。']};
